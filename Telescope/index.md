...
Notes: Average percentage coordination priority over swarm for this coordinator: 75%. Average number of coordinators per participant: 3 (Max 8, Min 1)

Caveats:
Contracts deployed for verification of neutron star existence: 5. (Standard unless otherwise noted)

Contracts deployed for verification of neutron star trajectory: 5
(It was dancing, I tell you...)

Contracts for verification of double slingshot: 8. Workers have to be >= 2AU away.
(That is so boring... I like hopscotch better. {Maybe we should do this in full flow mode, not team flow}. Or unvibed. {That would take forever})

Swarm provided compute for both Causal Set Services and Universal Translation. Request funding for crosstalk investigation contracts.
